                      ...
                      <td className={styles.numeric}>
                        {data.isLumpSum ? '-' : (() => {
                          ...
                          return effectivePricingMethod === 'sqft'
                            ...
                            : (item.fixedPrice ? `${formatCurrency(item.fixedPrice)}/piece` : '-');
                        })()}
                      </td>
              ...
              <div className={`${styles.footer} email-footer`}>
                <div className={`${styles.notesSection} email-notes-section`}>
                  ...
                  <div className={`${styles.salesTerms} email-sales-terms`}>
                    ...
                    ) : (data.documentType === 'WASH' || data.mode === 'wash') ? (
                      <>
                        <p>1- Customers will be notified when their rug(s) are ready for pickup.</p>
                        <p>2- Rugs not picked up within seven (7) days after notification will incur a storage fee of $50 per week, per invoice.</p>
