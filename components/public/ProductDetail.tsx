          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-6 space-y-4">
              ...
              >
                ...
                <div className="absolute bottom-3 right-3 bg-editorial-text/90 backdrop-blur-xs text-white text-[9px] uppercase tracking-widest font-bold px-2.5 py-1 rounded-none">
              ...
              <div className="p-4 bg-editorial-aside border border-editorial-border rounded-none flex items-center gap-3">
                ...
                <span className="text-[11px] leading-relaxed text-gray-500 font-sans font-light">
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="px-2.5 py-1 bg-editorial-text/90 text-[10px] text-white tracking-wider font-bold uppercase rounded-none">
                    {rug.origin}
                  </span>
                  <span className="px-2.5 py-1 bg-editorial-aside text-[10px] text-editorial-text tracking-wider font-bold uppercase rounded-none border border-editorial-border">
                    {rug.style} Style
                  </span>
                  <span className={`px-2.5 py-1 rounded-none text-[10px] tracking-wider font-bold uppercase border ${
              ...
              <div className="flex items-center gap-3 py-3 border-y border-editorial-border justify-between">
                <div>
                  <span className="text-[10px] text-gray-400 uppercase tracking-wider block font-semibold">Concierge Value</span>
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  {rug.availability === "In Stock" ? (
                    <button
                      ...
                      className="px-5 py-3.5 bg-editorial-accent hover:bg-[#8E7453] text-white font-bold uppercase tracking-widest text-[11px] rounded-none shadow-sm transition flex items-center gap-1.5 cursor-pointer"
                    >
                      <ShoppingBag className="h-4 w-4" />
                      <span>Add to Cart</span>
                    </button>
                  ) : (
                    <div className="px-4 py-3 bg-editorial-aside text-gray-500 rounded-none text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5 border border-editorial-border">
                  ...
                  <button
                    ...
                    className="px-5 py-3.5 border border-editorial-accent hover:bg-editorial-accent hover:text-white text-editorial-accent font-bold uppercase tracking-widest text-[11px] rounded-none transition flex items-center gap-1.5 cursor-pointer"
                  >
              ...
              <div className="space-y-2.5">
                <h4 className="text-[10px] uppercase tracking-widest text-editorial-accent font-bold">Museum-Grade Specifications</h4>
              ...
              <div className="space-y-1.5">
                <h4 className="text-[10px] uppercase tracking-widest text-editorial-accent font-bold">Curator's Narrative</h4>
          ...
          <div className="pt-10 border-t border-editorial-border grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[9px] text-gray-400">Authentic buyer reviews approved by Marco Polo showroom.</p>
                </div>
              ...
              {rugReviews.length === 0 ? (
                <div className="text-center py-10 bg-white rounded-none border border-editorial-border space-y-1">
                  ...
                  <p className="text-[10px] text-gray-400 font-light">Be the first to share your heirloom experience!</p>
                </div>
              ) : (
              ...
              {pendingReviewsCount > 0 && (
                <div className="p-3 bg-editorial-aside border border-editorial-border rounded-none text-[10px] text-editorial-accent flex items-center gap-2">
            ...
            <div className="lg:col-span-5 bg-white p-6 rounded-none border border-editorial-border space-y-4">
              <div className="text-center">
                ...
                <p className="text-[9px] text-gray-400 mt-0.5">Reviews go through curator approval before being displayed.</p>
              </div>

              <form onSubmit={handleSubmitReview} className="space-y-3 text-[10px] font-sans">
              ...
              {reviewSubmitted && (
                <div className="p-3 bg-green-50 border border-green-100 rounded-none text-[10px] text-green-700 text-center animate-fadeIn">
                  Review submitted successfully! It has been routed to the <strong>Admin moderation queue</strong> for verification.
                </div>
              )}
            </div>
          ...
          {relatedRugs.length > 0 && (
            <div className="pt-10 border-t border-editorial-border space-y-6">
              <div>
                ...
                <p className="text-[9px] text-gray-400">Other fine weaves matching {rug.origin} or {rug.style} styles in stock.</p>
              </div>
                ...
                {relatedRugs.map((relRug) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[9px] text-gray-400 font-light">{relRug.dimensions} | {relRug.origin}</p>
