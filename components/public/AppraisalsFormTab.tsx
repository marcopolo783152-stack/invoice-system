...
export function AppraisalsFormTab({ onCancel, editId }: { onCancel: () => void, editId: string | null }) {
    ...
    return (
        <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
            <button onClick={onCancel} style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: '#6366f1', fontSize: '14px', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px', marginBottom: '20px' }}>
                ...
                <form onSubmit={handleSubmit} style={{ padding: '30px' }}>
                    ...
                    <div style={{ marginTop: '40px', paddingTop: '20px', borderTop: '1px solid #e2e8f0', display: 'flex', justifyContent: 'flex-end', gap: '16px' }}>
                        <button 
                            ...
                            style={{ padding: '14px 24px', borderRadius: '10px', border: '1px solid #cbd5e1', background: 'white', color: '#475569', fontWeight: 'bold', textDecoration: 'none', cursor: 'pointer' }}
                        >
                            Cancel
                        </button>
                        <button 
