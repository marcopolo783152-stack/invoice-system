...
export const metadata: Metadata = {
  ...
  description: 'Expert handmade and area rug cleaning in Alexandria, VA. We remove deep soil, stains, and odors while protecting delicate fibers.',
  alternates: {
    canonical: '/services/rug-cleaning-alexandria-va',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Professional Area Rug Cleaning in Alexandria, VA",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Professional Area Rug Cleaning", "item": "https://www.marcopolorugs.com/services/rug-cleaning-alexandria-va" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Professional Area Rug Cleaning in Alexandria, VA"
        subtitle="Expert handmade and area rug cleaning in Alexandria, VA. We remove deep soil, stains, and odors while protecting delicate fibers."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our professional area rug cleaning service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
