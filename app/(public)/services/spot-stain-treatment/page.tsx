...
export const metadata: Metadata = {
  title: 'Rug Spot & Stain Treatment | Marco Polo Oriental Rugs',
  description: 'Targeted removal of wine, coffee, ink, and food stains from fine handmade rugs.',
  alternates: {
    canonical: '/services/spot-stain-treatment',
  }
};
...
export default function ServicePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Spot and Stain Treatment", "item": "https://www.marcopolorugs.com/services/spot-stain-treatment" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Rug Spot & Stain Treatment"
        subtitle="Targeted removal of wine, coffee, ink, and food stains from fine handmade rugs."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Spot and Stain Treatment Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our spot and stain treatment service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
