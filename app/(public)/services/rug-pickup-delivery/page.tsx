...
export const metadata: Metadata = {
  title: 'Rug Pickup & Delivery in Alexandria, VA | Marco Polo Oriental Rugs',
  description: 'Convenient rug pickup and delivery services for cleaning and repair across Alexandria, Arlington, and Washington, D.C.',
  alternates: {
    canonical: '/services/rug-pickup-delivery',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Rug Pickup & Delivery in Alexandria, VA",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Rug Pickup and Delivery", "item": "https://www.marcopolorugs.com/services/rug-pickup-delivery" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Rug Pickup & Delivery in Alexandria, VA"
        subtitle="Convenient rug pickup and delivery services for cleaning and repair across Alexandria, Arlington, and Washington, D.C."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Rug Pickup and Delivery Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our rug pickup and delivery service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
