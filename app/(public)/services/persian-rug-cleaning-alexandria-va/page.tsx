...
export const metadata: Metadata = {
  title: 'Persian Rug Cleaning Services | Alexandria, VA | Marco Polo Oriental Rugs',
  description: 'Gentle, traditional hand-washing for Persian rugs in Northern Virginia. We preserve the natural lanolin, dyes, and intricate weaves.',
  alternates: {
    canonical: '/services/persian-rug-cleaning-alexandria-va',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Persian Rug Cleaning Services | Alexandria, VA",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Persian Rug Cleaning", "item": "https://www.marcopolorugs.com/services/persian-rug-cleaning-alexandria-va" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Persian Rug Cleaning Services | Alexandria, VA"
        subtitle="Gentle, traditional hand-washing for Persian rugs in Northern Virginia. We preserve the natural lanolin, dyes, and intricate weaves."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our persian rug cleaning service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
