...
export const metadata: Metadata = {
  title: 'Fine Rug Hand Washing Services | Marco Polo Oriental Rugs',
  description: 'Traditional submerged hand-washing for delicate silk, antique, and fine wool rugs.',
  alternates: {
    canonical: '/services/fine-rug-hand-washing',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Fine Rug Hand Washing Services",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Fine Rug Hand Washing", "item": "https://www.marcopolorugs.com/services/fine-rug-hand-washing" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Fine Rug Hand Washing Services"
        subtitle="Traditional submerged hand-washing for delicate silk, antique, and fine wool rugs."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Fine Rug Hand Washing Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our fine rug hand washing service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
