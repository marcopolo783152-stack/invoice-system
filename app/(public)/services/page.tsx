...
export const metadata: Metadata = {
  title: 'Wool Rug Cleaning | Alexandria, VA | Marco Polo Oriental Rugs',
  description: 'Deep cleaning for wool area rugs that restores softness, vibrant colors, and removes embedded dust.',
  alternates: {
    canonical: '/services/wool-rug-cleaning',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Wool Rug Cleaning | Alexandria, VA",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Wool Rug Cleaning", "item": "https://www.marcopolorugs.com/services/wool-rug-cleaning" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Wool Rug Cleaning | Alexandria, VA"
        subtitle="Deep cleaning for wool area rugs that restores softness, vibrant colors, and removes embedded dust."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our wool rug cleaning service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
