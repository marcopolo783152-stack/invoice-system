...
export const metadata: Metadata = {
  title: 'Professional Rug Appraisals | Marco Polo Oriental Rugs',
  description: 'Certified written appraisals for insurance, estate, and resale purposes by our master rug experts.',
  alternates: {
    canonical: '/services/rug-appraisals',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Professional Rug Appraisals",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Rug Appraisals", "item": "https://www.marcopolorugs.com/services/rug-appraisals" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Professional Rug Appraisals"
        subtitle="Certified written appraisals for insurance, estate, and resale purposes by our master rug experts."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Rug Appraisals Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our rug appraisals service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
