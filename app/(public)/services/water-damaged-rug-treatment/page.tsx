...
export const metadata: Metadata = {
  title: 'Water-Damaged Rug Treatment | Marco Polo Oriental Rugs',
  description: 'Emergency and restorative care for rugs damaged by floods, leaks, or water exposure.',
  alternates: {
    canonical: '/services/water-damaged-rug-treatment',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Water-Damaged Rug Treatment",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Water-Damaged Rug Treatment", "item": "https://www.marcopolorugs.com/services/water-damaged-rug-treatment" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Water-Damaged Rug Treatment"
        subtitle="Emergency and restorative care for rugs damaged by floods, leaks, or water exposure."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Water-Damaged Rug Treatment Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our water-damaged rug treatment service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
