...
export const metadata: Metadata = {
  title: 'Antique Rug Cleaning Experts | Marco Polo Oriental Rugs',
  description: 'Careful, chemical-free cleaning for fragile antique rugs to ensure their preservation for generations.',
  alternates: {
    canonical: '/services/antique-rug-cleaning',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Antique Rug Cleaning Experts",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Antique Rug Cleaning", "item": "https://www.marcopolorugs.com/services/antique-rug-cleaning" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Antique Rug Cleaning Experts"
        subtitle="Careful, chemical-free cleaning for fragile antique rugs to ensure their preservation for generations."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our antique rug cleaning service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
