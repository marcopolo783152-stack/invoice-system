...
export const metadata: Metadata = {
  title: 'Fringe, Binding, and Edge Repair | Marco Polo Oriental Rugs',
  description: 'Secure your rug\'s borders with professional fringe replacement, binding, and edge surging.',
  alternates: {
    canonical: '/services/fringe-binding-edge-repair',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Fringe, Binding, and Edge Repair",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Fringe, Binding, and Edge Repair", "item": "https://www.marcopolorugs.com/services/fringe-binding-edge-repair" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Fringe, Binding, and Edge Repair"
        subtitle="Secure your rug&apos;s borders with professional fringe replacement, binding, and edge surging."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Fringe, Binding, and Edge Repair Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our fringe, binding, and edge repair service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
