...
export const metadata: Metadata = {
  title: 'Custom-Fitted Rug Pads | Marco Polo Oriental Rugs',
  description: 'High-quality, custom-cut rug padding to prevent slipping, protect your floors, and extend the life of your rug.',
  alternates: {
    canonical: '/services/rug-pads-custom-padding',
  }
};
...
export default function ServicePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Rug Pads and Custom-Fitted Padding", "item": "https://www.marcopolorugs.com/services/rug-pads-custom-padding" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Custom-Fitted Rug Pads"
        subtitle="High-quality, custom-cut rug padding to prevent slipping, protect your floors, and extend the life of your rug."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Rug Pads and Custom-Fitted Padding Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our rug pads and custom-fitted padding service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
