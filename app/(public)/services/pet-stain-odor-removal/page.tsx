...
export const metadata: Metadata = {
  title: 'Pet Stain & Odor Removal for Fine Rugs | Marco Polo Oriental Rugs',
  description: 'Enzymatic pet stain and odor removal for Oriental and Persian rugs. We permanently remove accidents without damaging delicate dyes.',
  alternates: {
    canonical: '/services/pet-stain-odor-removal',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Pet Stain & Odor Removal for Fine Rugs",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Pet Stain and Odor Removal", "item": "https://www.marcopolorugs.com/services/pet-stain-odor-removal" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Pet Stain & Odor Removal for Fine Rugs"
        subtitle="Enzymatic pet stain and odor removal for Oriental and Persian rugs. We permanently remove accidents without damaging delicate dyes."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our pet stain and odor removal service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
