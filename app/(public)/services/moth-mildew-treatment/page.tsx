...
export const metadata: Metadata = {
  title: 'Moth & Mildew Treatment for Rugs | Marco Polo Oriental Rugs',
  description: 'Eradicate moth larvae and mildew from wool and silk rugs, followed by preventative treatments.',
  alternates: {
    canonical: '/services/moth-mildew-treatment',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Moth & Mildew Treatment for Rugs",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Moth and Mildew Treatment", "item": "https://www.marcopolorugs.com/services/moth-mildew-treatment" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Moth & Mildew Treatment for Rugs"
        subtitle="Eradicate moth larvae and mildew from wool and silk rugs, followed by preventative treatments."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Moth and Mildew Treatment Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our moth and mildew treatment service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
