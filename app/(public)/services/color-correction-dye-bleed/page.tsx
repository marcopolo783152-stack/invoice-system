...
export const metadata: Metadata = {
  title: 'Color Correction & Dye-Bleed Treatment | Marco Polo Oriental Rugs',
  description: 'Advanced color correction to fix dye migration and bleeding in handmade rugs.',
  alternates: {
    canonical: '/services/color-correction-dye-bleed',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Color Correction & Dye-Bleed Treatment",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Color Correction and Dye-Bleed Treatment", "item": "https://www.marcopolorugs.com/services/color-correction-dye-bleed" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Color Correction & Dye-Bleed Treatment"
        subtitle="Advanced color correction to fix dye migration and bleeding in handmade rugs."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Color Correction and Dye-Bleed Treatment Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our color correction and dye-bleed treatment service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
