...
export const metadata: Metadata = {
  title: 'Expert Rug Repair in Alexandria, VA | Marco Polo Oriental Rugs',
  description: 'Professional rug repair services in Alexandria including fringe repair, binding, edge surging, and hole reweaving.',
  alternates: {
    canonical: '/services/rug-repair-alexandria-va',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Expert Rug Repair in Alexandria, VA",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Rug Repair", "item": "https://www.marcopolorugs.com/services/rug-repair-alexandria-va" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Expert Rug Repair in Alexandria, VA"
        subtitle="Professional rug repair services in Alexandria including fringe repair, binding, edge surging, and hole reweaving."
      >
        <section>
          ...
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our rug repair service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
