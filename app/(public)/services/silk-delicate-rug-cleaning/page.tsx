...
export const metadata: Metadata = {
  title: 'Silk & Delicate Rug Cleaning | Marco Polo Oriental Rugs',
  description: 'Specialized low-moisture and delicate washing protocols for pure silk and silk-blend rugs.',
  alternates: {
    canonical: '/services/silk-delicate-rug-cleaning',
  }
};
...
export default function ServicePage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "Silk & Delicate Rug Cleaning",
    "provider": {
      "@type": "LocalBusiness",
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Silk and Delicate Rug Cleaning", "item": "https://www.marcopolorugs.com/services/silk-delicate-rug-cleaning" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Silk & Delicate Rug Cleaning"
        subtitle="Specialized low-moisture and delicate washing protocols for pure silk and silk-blend rugs."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Silk and Delicate Rug Cleaning Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our silk and delicate rug cleaning service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
