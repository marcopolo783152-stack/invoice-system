...
export const metadata: Metadata = {
  title: 'Rug Protection Treatment | Marco Polo Oriental Rugs',
  description: 'Stain-repellent treatments that protect your rug\'s fibers from spills and premature wear.',
  alternates: {
    canonical: '/services/rug-protection-treatment',
  }
};
...
export default function ServicePage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Rug Protection Treatment", "item": "https://www.marcopolorugs.com/services/rug-protection-treatment" }
    ]
  };
  ...
  return (
    <>
      ...
      <ServicePageLayout
        title="Rug Protection Treatment"
        subtitle="Stain-repellent treatments that protect your rug&apos;s fibers from spills and premature wear."
      >
        <section>
          <h2 className="text-2xl font-serif mb-4 flex items-center">
            <Sparkles className="w-5 h-5 mr-3 text-editorial-accent" />
            Our Rug Protection Treatment Process
          </h2>
          <p className="text-neutral-600 leading-relaxed mb-6 font-light">
            At Marco Polo Oriental Rugs in Alexandria, VA, we treat every rug as a unique work of art. Our rug protection treatment service is tailored to the specific weave, dyes, and condition of your piece.
          </p>
