...
function AppContent() {
  const { activeView, showroomAnnouncement, socialLinks, setActiveView, logoutUser, currentUser, isEditMode, setIsEditMode, websiteContent, saveWebsiteContent } = useStore();
