...
const googleReviewLink = "https://www.google.com/search?gs_ssp=eJzj4tZP1zcsycjNKS8sMGC0UjWosLBMMk8yMkkzTUpMtkhMNrQyqDBLSrI0TkxMNk40NjUxMEz0kshNLErOVyjIz8lXyC_KTM0rScxRKCpNLwYAs7cZHQ&q=marco+polo+oriental+rugs&rlz=1C1ONGR_enUS1146US1146&oq=ma&gs_lcrp=EgZjaHJvbWUqFQgBEC4YJxivARjHARiABBiKBRiOBTIPCAAQIxgnGOMCGIAEGIoFMhUIARAuGCcYrwEYxwEYgAQYigUYjgUyBggCEEUYOzIGCAMQRRg5MgYIBBBFGDwyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDzSAQgyNDU5ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8";

// I will overwrite the entire emailBody object carefully
const targetEmailBody = `        const emailBody = {
          personalizations: [{
...
const replacementEmailBody = `        const emailBody = {
          personalizations: [{
            to: [{ email: customerInfo.email }],
            subject: type === 'invoice' 
              ? \`Official Invoice - \${shopProfile?.name || 'Marco Polo'} (\${order.id})\`
          ...
          content: [{
            ...
            value: type === 'invoice' ? \`
              <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
                ...
                <p>If you are happy with your experience, we would be incredibly grateful if you could take a moment to <a href="${googleReviewLink}" target="_blank" style="color: #8E7453; font-weight: bold;">leave us a review on our Google profile</a>.</p>
...
if (content.includes(targetEmailBody)) {
    content = content.replace(targetEmailBody, replacementEmailBody);
